            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-dark">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/home') }}">
                        <img src="{{ asset('images/logo_bk2_sm.png') }}" width="100px" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <div class="warner mr-4" style="display: none;">
                                <li class="nav-item">
                                    <span class="d-none d-md-block badge badge-pill badge-danger warn-badge warn-badge-right"></span>
                                    <a class="d-none d-md-block nav-link" href="#" role="button">
                                        <x-bi-bell/>
                                    </a>
                                    <button type="button" class="d-block d-md-none btn btn-outline-danger btn-sm">
                                        <span class='warn-badge'></span> Alerta(s)
                                    </button>
                                </li>
                            </div>
