...
@section('content')
    ...
    <div class="container mt-2 pt-2">
        ...
        <div class="row mb-3">
            <div class="col">
                <h2>{{$language::get('attachments')}}</h2>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-10">
                <div class="form-group">
                    <input type="text" class="form-control" url="{{route('attachment.search')}}/" id="search" placeholder="{{$language::get('search')}} {{strtolower($language::get('attachment'))}}" />
                </div>
            </div>
