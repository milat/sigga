...
<fieldset>
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="form-group">
                <label for="phone_phone_type_id" @if(!isset($phoneRequired) || $phoneRequired == true) class='required' @endif>{{$language::get('phone_type_id')}} {{$language::get('phone_main')}}</label>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="form-group">
                <label for="phone_number" @if(!isset($phoneRequired) || $phoneRequired == true) class='required' @endif>{{$language::get('phone_number')}}</label>
    ...
    @if(!isset($phoneRequired) || $phoneRequired == true)
        <hr />
