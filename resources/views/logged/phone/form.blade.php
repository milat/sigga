...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3">
            <div class="form-group">
                <label for="phone_phone_type_id_2" class='required'>{{$language::get('phone_type_id')}} {{$language::get('phone_secondary')}}</label>
        ...
        <div class="col-12 col-md-2">
            <div class="form-group">
                <label for="phone_number_2" class='required'>{{$language::get('phone_number')}}</label>
